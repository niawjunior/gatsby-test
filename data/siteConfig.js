module.exports = {
  ...
  authorDescriptionAdminOne:
    'ชื่นชอบในการเขียน JavaScript และ เทคโนโลยีใหม่ๆ งานอดิเรก นอกจากเขียนโค้ด ชอบดู มวยสากล, mma, นอนดู netflix ฝึกภาษา เข้าร้านกาแฟ และ ชอบแมว ',
  ...
  pathPrefix: '/',
  siteCover: 'learn.png',
  googleAnalyticsId: 'UA-143755483-2',
  ...
  footerLinks: [
    ...
    {
      sectionName: 'ติดตามได้ที่',
      links: [
        {
          label: 'เว็บไซต์',
          url: 'https://www.jskhamkham.com/',
        },
        {
          label: 'เฟสบุ๊คเพจ',
          url: 'https://facebook.com/JSKhamKham/',
        },
      ],
    },
  ],
